...
export BASH_DATA_HOME="${BASH_DATA_HOME:-$XDG_DATA_HOME/bash}"
export BASH_CACHE_HOME="${BASH_CACHE_HOME:-$XDG_CACHE_HOME/bash}"
export REPO_HOME="${REPO_HOME:-$BASH_CACHE_HOME/repos}"
